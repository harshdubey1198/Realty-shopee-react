...
function DescriptionThird() {
  return (
    <div className='desc-third'>
        <div className='desc3-img'>
            <img src="https://res.cloudinary.com/dgplzytrq/image/upload/v1719049168/Description%20Images/Sachin-Gupta.jpg" alt="Sachin Sir Founder" />
            <span className='owner'>Mr.Sachin Kumar Gupta</span> 
        </div>
        <div className='content-desc3'>
...
export default DescriptionThird
