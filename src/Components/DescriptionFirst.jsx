  ...
  return (
    <div className='description1-home'>
      ...
      <div className='content-des1'>
        <h2>Explore Premier New Launch  Luxury Property in Gurgaon</h2>
        <p>
        Discover the new launch luxury property in Gurgaon with Realty Shopee, your trusted property management company in Gurgaon. Whether you're searching for a dream home, a strategic commercial space, or a lucrative SCO (Shop-Cum-Office), we cater to all your property needs in this dynamic city.
       <br/><br/>
