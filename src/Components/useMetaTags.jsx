...
const metaTagsConfig = {
  ...
  "/sco-plots-in-gurgaon": {
    ...
    description: "Realty Shopee offers premium residential and commercial SCO plots for sale in Gurgaon with two-sided open layouts. Explore affordable options at Realty Shopee.",
    ...
    additionalMetaTags: [
        ...
        { property: 'og:description', content: 'Realty Shopee offers premium residential and commercial SCO plots for sale in Gurgaon with two-sided open layouts. Explore affordable options at Realty Shopee.' },
        ...
        { name: 'twitter:description', content: 'Realty Shopee offers premium residential and commercial SCO plots for sale in Gurgaon with two-sided open layouts. Explore affordable options at Realty Shopee.' },
